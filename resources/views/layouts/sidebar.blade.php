        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="kpi">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{route('subkriteria.index')}}">Sub Kriteria</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#penilaian" aria-expanded="false" aria-controls="penilaian">
