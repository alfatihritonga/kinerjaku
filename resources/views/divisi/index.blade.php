...
<h1 class="h3">Data Divisi</h1>
<p>Halaman untuk mengelola data divisi</p>
...
<tbody>
    ...
    <tr>
        ...
        <td>{{$divisi->nama}}</td>
        <td>
            <a href="{{route('divisi.show', $divisi->id)}}" class="badge badge-primary text-decoration-none">
                <i class="icon-eye"></i>
            </a>
            <a href="{{route('divisi.edit', $divisi->id)}}" class="badge badge-warning text-decoration-none">
                <i class="icon-note"></i>
            </a>
