...
@section('content')
    ...
    <div id="toolbar">
        <a href="{{ route('hasil.kpi.cetak', [$hasilKpi->first()->periode_id, 4]) }}" class="btn btn-primary btn-icon-text">
    ...
    <table data-toggle="table" data-pagination="true" data-search="true" data-toolbar="#toolbar">
        <thead>
            ...
            <tr>
                <th data-field="nilai_oleh_satu" data-sortable="true">Ketua</th>
                <th data-field="nilai_oleh_dua" data-sortable="true">Waka</th>
            </tr>
        </thead>
        <tbody>
