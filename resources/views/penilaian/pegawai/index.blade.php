...
<p>📢 <strong>{{ $periode->nama }}</strong> ({{ $periode->tanggal_mulai }} - {{ $periode->tanggal_selesai }})</p>
        ...
        <tr>
            ...
            <td>
                ...
                @else
                    ...
                    <a href="{{ route('penilaian.create', [$pegawai->id, $tanggal]) }}" class="badge badge-primary text-decoration-none">Nilai Sekarang</a>
                @endif
            </td>            
        </tr>
        @endforeach
