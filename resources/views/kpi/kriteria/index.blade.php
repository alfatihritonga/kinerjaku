...
<tbody>
    ...
    <tr>
        ...
        <td>
            <a href="{{route('kriteria.show', $kriteria->id)}}" class="badge badge-primary text-decoration-none">
                <i class="icon-eye"></i>
            </a>
            <a href="{{route('kriteria.edit', $kriteria->id)}}" class="badge badge-warning text-decoration-none">
                <i class="icon-note"></i>
            </a>
